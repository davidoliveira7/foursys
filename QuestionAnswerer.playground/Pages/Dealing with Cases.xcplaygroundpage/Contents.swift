...
func responseTo(question: String) -> String {​​        // Forma otimizada - by Andrey - sem variável adicional//    if question.lowercased().hasPrefix("hello") {​​        // Forma mais acadêmica - usando uma variável adicional    let lowerQuestion = question.lowercased()        if lowerQuestion.hasPrefix("hello") {​​        return "E aí, beleza!"    }​​ else {​​        return "Putz, aí depende"    }​​}​​responseTo(question: "HELLO!")
