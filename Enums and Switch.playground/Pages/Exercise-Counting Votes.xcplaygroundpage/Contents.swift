...
print("Praia: \(beachVotes), Fabrica: \(factoryVotes)")
}
/*:
### Extension:
...
if salamanderVotes > marmotVotes && salamanderVotes > neitherVotes{
    print("O novo marcote eh salamandra")
}if marmotVotes > salamanderVotes && marmotVotes > neitherVotes
    print("O novo marcote eh marmotVotes")
