...
// numero de hamsters = h
let numberOfHamsters = 7

// total de animais
let totalA = numberOfDogs + numberOfCats + numberOfTurtles + numberOfHamsters

// total de mamiferos
let totalM = numberOfDogs + numberOfCats + numberOfHamsters
