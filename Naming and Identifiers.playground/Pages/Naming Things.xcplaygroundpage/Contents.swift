...
let numeroDeCachorro = 8 + 3

let numeroDeGatos = 6

let numeroDeTartaruga = 3

let numeroDeHamisters = 2
...
let totalDeAnimais = numeroDeCachorro + numeroDeGatos + numeroDeTartaruga + numeroDeHamisters

let totalDeMamiferos = numeroDeCachorro + numeroDeGatos + numeroDeHamisters
