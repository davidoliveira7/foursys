...
print ("Eu vou \(viajar), vou passear, \(ferias) de \(amor) Junto com você meu \(viver) vou ter, \(viajar) de \(ferias) Como é lindo amar, como é bom sonhar, \(amor) de \(viver) Vamos conhecer coisas do \(viver), \(viajar) de \(ferias).")
/*:
